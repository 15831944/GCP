...
//[assembly: log4net.Config.XmlConfigurator(ConfigFile = @"C:\Datax\Assembly\Banner.dll.Config", Watch = true)]
...
namespace Banner
{
  ...
  //      public static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        [CommandMethod("Banner", CommandFlags.Session)]
        public static void GetAlltext(string[] args)
        {
            ...
            try
            {
                ...
                if (dsResult == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    bd.BannerLine1 = ds.MyLine1;
                    bd.BannerLine2 = ds.MyLine2;
                    bd.BannerLine3 = ds.MyLine3;
                    bd.Drawer = ds.MyDrawer;
                    bd.DwnDate = ds.MyDate.Date;
                    bd.ReservedText = ds.MyReservedText;
                    bd.UploadDwg = ds.MyUploadDwg;

                    var MyIni = new IniFile("Setting.ini");
                    bd.ErrorTextFile = MyIni.Read("BannerErrorLogFilePath", "Banner"); // @"C:\Datax\Errorlogs\BannerErrors.txt";
        ...
        public class ExtApp : IExtensionApplication
        {
            ...
            public void Initialize()
            {
                ...
                if (Autodesk.Windows.ComponentManager.Ribbon == null)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("ExtApp::Initialize called ok");
                ...
                else
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("ExtApp::Initialize calling CreateRibbon");
            ...
            public void CreateRibbon()
            {
                ...
                RibButton.Text = "Banner";
                RibButton.ShowText = true;
                RibButton.Id = "GPCL_03";
                RibButton.CommandParameter = "Banner ";
